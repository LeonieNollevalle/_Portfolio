  ...
  return (
    <div className="w-screen h-screen overflow-x-hidden pb-10">
      ...
      <div className=" w-full  flex flex-col items-center justify-center pt-5 lg:flex-row lg:items-start md:flex-row md:items-start sm:flex-row sm:items-start">
        ...
        <p className="w-5/6  lg:w-2/3 md:w-3/4 sm:3/4">Hybrides de par mon parcours, je me sers de chacune de mes compétences acquises dans le domaine du design graphique, du développement web et de l’UX design, afin de développer une expérience centrée utilisateurs sur des interfaces numérique et print. </p>
        </div>
